...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/constants-float64-max-nth-factorial/tags). For example,

```javascript
FLOAT64_MAX_NTH_FACTORIAL = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-max-nth-factorial@v0.1.0-umd/browser.js' )
```
